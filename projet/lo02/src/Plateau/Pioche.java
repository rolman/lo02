...
import jeu.CroyantAlchimistesType1;
import jeu.CroyantAlchimistesType2;
import jeu.CroyantAlchimistesType3;
import jeu.CroyantAlienes;
import jeu.CroyantAlienesType1;
import jeu.CroyantAlienesType2;
import jeu.CroyantAlienesType3;
...
import jeu.CroyantTravailleursType1;
import jeu.CroyantTravailleursType2;
import jeu.CroyantTravailleursType3;
...
//CREATION DES CROYANTS ET AJOUT DANS LA PIOCHE
		...
		CroyantTravailleursType1 CroyantTravailleurs1= new CroyantTravailleursType1("Croyant Travailleurs1", tabCroyantTravailleurs1);
		...
		CroyantTravailleursType2 CroyantTravailleurs2= new CroyantTravailleursType2("Croyant Travailleurs2", tabCroyantTravailleurs2);
		...
		CroyantTravailleursType3 CroyantTravailleurs3= new CroyantTravailleursType3("Croyant Travailleurs3", tabCroyantTravailleurs3);
		...
		CroyantAlchimistesType1 CroyantAlchimistes1 = new CroyantAlchimistesType1("Croyant Alchimiste1", tabCroyantAlchimistes1);
		tasDeCartes.add(CroyantAlchimistes1);
		
		boolean tabCroyantAlchimistes2[]={true,false,false,true,true};
		CroyantAlchimistesType2 CroyantAlchimistes2 = new CroyantAlchimistesType2("Croyant Alchismiste2", tabCroyantAlchimistes2);
		tasDeCartes.add(CroyantAlchimistes2);
		
		boolean tabCroyantAlchimistes3[]={true,false,false,true,true};
		CroyantAlchimistesType3 CroyantAlchimistes3 = new CroyantAlchimistesType3("Croyant Alchismiste3", tabCroyantAlchimistes3);
		...
		CroyantAlienesType1 CroyantAlienes1 = new CroyantAlienesType1("Croyant Aliénés1", tabCroyantAlienes1);
		tasDeCartes.add(CroyantAlienes1);
		
		boolean tabCroyantAlienes2[]={true,true,true,false,false};
		CroyantAlienesType2 CroyantAlienes2 = new CroyantAlienesType2("Croyant Aliénés2", tabCroyantAlienes2);
		tasDeCartes.add(CroyantAlienes2);
		
		boolean tabCroyantAlienes3[]={false,true,false,true,true};
		CroyantAlienesType3 CroyantAlienes3 = new CroyantAlienesType3("Croyant Aliénés3", tabCroyantAlienes3);
